    ...
    public partial class BasicEntitiesMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AFEntities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignThings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CampaignThings_CampaignTypes_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignThings_CampaignId",
                table: "CampaignThings",
                column: "CampaignId");
        }
